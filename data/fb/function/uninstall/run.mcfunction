...
tellraw @s [{"text": "[fb] ", "color": "green"}, {"text": "/datapack enable \"file/FunctionBook\"" ,"color": "gray", "clickEvent": {"action": "suggest_command", "value": "/datapack enable \"file/FunctionBook\""}}, {"text": " で再インストールできます。", "color": "yellow"}]